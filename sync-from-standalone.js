 ...
 *
 * Usage:
 *   node sync-from-standalone.js           # regenerate
 *   node sync-from-standalone.js --check   # diff-only (exit 1 on drift)
 *   node sync-from-standalone.js --src <f> # alternate source
 *
...
const BANNER_HTML = `<!-- DO NOT EDIT — auto-generated from ${src} | Regenerate: node sync-from-standalone.js -->\n`;
...
if (checkMode) {
  ...
  if (drifted) {
    console.error('[sync:check] Fix: node sync-from-standalone.js');
    process.exit(1);
  }
